...
const initialTemplate = [
  ...
  '        </mj-column>',
  '        <mj-column>',
  '          <mj-text align="right" color="#FFFFFF" font-size="14px" padding="0">',
  ...
  '        <mj-column>',
  '          <mj-image src="https://images.unsplash.com/photo-1557683316-973673baf926?q=80&w=1200&auto=format&fit=crop" padding="0" alt="Hero Banner" />',
  '        </mj-column>',
  '      </mj-section>',
  '',
  ...
  '        <mj-column width="50%">',
  '          <mj-image width="60px" src="https://cdn-icons-png.flaticon.com/512/1828/1828919.png" padding="0 0 12px" alt="Drag Drop Icon" />',
  ...
  '',
  '        <mj-column width="50%">',
  '          <mj-image width="60px" src="https://cdn-icons-png.flaticon.com/512/906/906175.png" padding="0 0 12px" alt="Code Icon" />',
  '          <mj-text font-weight="600" padding="0 0 8px">',
  '            Clean MJML Output',
  '          </mj-text>',
  '          <mj-text>',
  ...
  '        <mj-column width="50%">',
  '          <mj-image src="https://images.unsplash.com/photo-1547658719-da2b51169166?q=80&w=800&auto=format&fit=crop" padding="0" alt="Editor Preview" />',
  '        </mj-column>',
  '        <mj-column width="50%">',
  '          <mj-text font-weight="600" padding="0 0 8px">',
  '            Live Visual Editing',
