...
const initialTemplate = [
  ...
  '',
  '    <!-- OUTER WRAPPER (Outlook-safe full width background) -->',
  '    <mj-wrapper background-color="#F5F5F5" padding="24px 20px" full-width="full-width">',
  '',
  '      <!-- BRAND HEADER -->',
  '      <mj-section background-color="#86BD40" padding="14px 24px">',
  '        <mj-column>',
  '          <mj-text align="center" color="#FFFFFF" font-size="14px" padding="0">',
  '            Welcome to my custom email editor built with GrapesJS and MJML! Start designing your responsive email now.',
  '          </mj-text>',
  '        </mj-column>',
  '      </mj-section>',
  '',
  '      <!-- HERO BLOCK (Primary Editable Area) -->',
  ...
  '            Your custom GrapesJS + MJML editor now gives you more flexibility, better layout control, and production-ready email output.',
  '          </mj-text>',
  ...
  '          </mj-text>',
  '          <mj-text>',
  '            Easily duplicate sections, rearrange content, and customize layouts without touching code.',
  '          </mj-text>',
  '        </mj-column>',
  '        <mj-column width="50%">',
  '          <mj-text font-weight="600" padding="0 0 8px">',
  ...
  '          </mj-text>',
  '          <mj-text>',
  '            Generate responsive, Outlook-safe HTML emails optimized for real-world delivery.',
  '          </mj-text>',
  '        </mj-column>',
  '      </mj-section>',
  '',
  '      <!-- IMAGE + TEXT BLOCK -->',
  '      <mj-section background-color="#FAFBFC" padding="30px 24px">',
  '        <mj-column width="50%">',
  '          <mj-image src="https://via.placeholder.com/260x180" padding="0" alt="Editor Preview" />',
  '        </mj-column>',
  '        <mj-column width="50%">',
  '          <mj-text font-weight="600" padding="0 0 8px">',
  '            Live Visual Editing',
  ...
  '            See your changes instantly inside the canvas. Modify typography, spacing, and colors with ease.',
  '          </mj-text>',
  ...
  '          </mj-text>',
  '          <mj-text padding="0 0 20px">',
  '            Design, preview, and export responsive emails directly from your custom GrapesJS environment.',
  '          </mj-text>',
  '          <mj-button background-color="#86BD40" color="#FFFFFF" href="#">',
  ...
  '',
  '      <!-- FOOTER -->',
  '      <mj-section background-color="#FAFBFC" padding="20px 24px">',
  '        <mj-column>',
